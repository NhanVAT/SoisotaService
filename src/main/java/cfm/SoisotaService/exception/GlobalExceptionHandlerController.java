...
public class GlobalExceptionHandlerController {
  ...
  public ResponseEntity<ResponseObjectDTO> handleInvalidArgument( MethodArgumentNotValidException ex, HttpServletResponse res){
    ...
    try {
      ...
      return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
              new ResponseObjectDTO(false, HttpStatus.BAD_REQUEST.name(), mapper.readValue(jsonResult, Object.class))
      );
